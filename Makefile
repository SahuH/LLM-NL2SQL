...
eval:
		...
		python test-suite-sql-eval/evaluation.py --gold $(BASE_DIR)/eval/gold.txt --pred $(BASE_DIR)/eval/pred.txt --db dataset_files/ori_dataset/spider/database --table dataset_files/ori_dataset/spider/tables.json --etype all
